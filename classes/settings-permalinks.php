...
class WPSC_Settings_Tab_Permalinks extends _WPSC_Settings_Tab_Form
{
	...
	public function display() {
		...
		$base_shop_url      = wpsc_get_store_url();
		...
		<table class="form-table">
			<tbody>
				<tr valign="top">
					<th scope="row">
						<?php esc_html_e( 'Main store location', 'wpsc' ); ?>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<?php esc_html_e( 'Sample single product location', 'wpsc' ); ?>
					</th>
					<td>
				...
				<tr valign="top">
					...
					<td>
						<?php echo make_clickable( wpsc_get_transaction_result_url() ); ?>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row">
					...
					<td>
						<?php echo make_clickable( wpsc_get_customer_account_url() ); ?>
					</td>
				</tr>
			</tbody>
		</table>
	...
	private function populate_form_array() {
		...
		$this->form_array = array(
			'store_slug' => array(
				'type'        => 'textfield',
				'title'       => _x( 'Store base slug', 'permalinks setting', 'wpsc' ),
